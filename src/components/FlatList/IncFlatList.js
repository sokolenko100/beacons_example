...
export default class IncFlatList extends Component {
    ...
    static defaultProps = {
        ...
        refreshableColors: [skin.$deepGreen],
        refreshableProgressBackgroundColor: 'white',
        refreshableSize: undefined,
        refreshableTintColor: skin.$deepGreen,
    ...
    componentDidMount() {
        ...
        this.mounted = true;
        if (this.props.firstLoader && this.props.onFetch) {
